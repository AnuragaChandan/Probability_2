...
\author{ Kondaparthy Anuraga Chandan$^{*}$% <-this % stops a space
	\thanks{*The student is with the Department
		...
		502285 India e-mail: ai22btech11011@iith.ac.in.}
...
\\\\ P(X=r) = $n \choose r$ $(p)^r$ $(1-p)^{n-r}$ , here p = $\frac{1}{2}$, n = 2.  \\ \begin{center}  $\therefore$ P(X=r) = $2 \choose r$ $ (\frac{1}{2}) ^2 $ \end{center}
\begin{align}
...
\\\\ P(Y=r) = $n \choose r$ $(p)^r$ $(1-p)^{n-r}$ , here p = $\frac{1}{2}$, n = 3. \\ \begin{center}  $\therefore$ P(Y=r) = $3 \choose r$ $ (\frac{1}{2}) ^3 $ \end{center}
\begin{align}
...
\\\\ P(Z=r) = $n \choose r$ $(p)^r$ $(1-p)^{n-r}$ , here p = $\frac{1}{2}$, n = 4. \\ \begin{center}  $\therefore$ P(Z=r) = $4 \choose r$ $ (\frac{1}{2}) ^4 $ \end{center}
\begin{align}
